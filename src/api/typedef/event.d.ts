    ...
    namespace mesg {
        ...
        namespace types {
            ...
            interface IEvent {
                ...
                /** Event data */
                data?: (mesg.protobuf.IStruct|null);
            }
            ...
            class Event implements IEvent {
                 ...
                 */
                constructor(properties?: mesg.types.IEvent);
                ...
                /** Event data. */
                public data?: (mesg.protobuf.IStruct|null);
            }
        }
        ...
        namespace api {
            ...
            class Event extends $protobuf.rpc.Service {
                 ...
                 */
                public create(request: mesg.api.ICreateEventRequest, callback: mesg.api.Event.CreateCallback): void;
                 ...
                 * @returns Promise
                 */
                public create(request: mesg.api.ICreateEventRequest): Promise<mesg.api.CreateEventResponse>;
                 ...
                 */
                public stream(request: mesg.api.IStreamEventRequest, callback: mesg.api.Event.StreamCallback): void;
                 ...
                 * @returns Promise
                 */
                public stream(request: mesg.api.IStreamEventRequest): Promise<mesg.types.Event>;
            }

            namespace Event {

                /**
                 * Callback as used by {@link mesg.api.Event#create}.
                 * @param error Error, if any
                 * @param [response] CreateEventResponse
                 */
                type CreateCallback = (error: (Error|null), response?: mesg.api.CreateEventResponse) => void;

                /**
                 * Callback as used by {@link mesg.api.Event#stream}.
                 * @param error Error, if any
                 * @param [response] Event
                 */
                type StreamCallback = (error: (Error|null), response?: mesg.types.Event) => void;
            }
            ...
            interface IStreamEventRequest {
                ...
                filter?: (mesg.api.StreamEventRequest.IFilter|null);
            }
            ...
            class StreamEventRequest implements IStreamEventRequest {
                 ...
                 * @param [properties] Properties to set
                 */
                constructor(properties?: mesg.api.IStreamEventRequest);

                /** StreamEventRequest filter. */
                public filter?: (mesg.api.StreamEventRequest.IFilter|null);
            }
            ...
            namespace StreamEventRequest {
                ...
                class Filter implements IFilter {
                     ...
                     * @param [properties] Properties to set
                     */
                    constructor(properties?: mesg.api.StreamEventRequest.IFilter);
            ...
            class CreateEventRequest implements ICreateEventRequest {
                 ...
                 * @param [properties] Properties to set
                 */
                constructor(properties?: mesg.api.ICreateEventRequest);
            ...
            class CreateEventResponse implements ICreateEventResponse {
                 ...
                 * @param [properties] Properties to set
                 */
                constructor(properties?: mesg.api.ICreateEventResponse);
